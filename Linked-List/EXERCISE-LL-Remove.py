...
class LinkedList:
    ...
    def remove(self, index):
        # check to see if the index less than 0 or index is greater
        # than or equal to the length of the LL returns None
        if index < 0 or index >= self.length:
            return None
        # check to see if the index equals 0 then it will
        # pop the head of the LL
        if index == 0:
            return self.pop_first()
        # check to see if the index is equal to the length of the LL - 1
